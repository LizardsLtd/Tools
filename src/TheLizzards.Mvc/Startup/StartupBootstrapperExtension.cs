...
namespace TheLizzards.Mvc.Startup
{
    public static class StartupBootstrapperExtension
    {
        ...
        public static IConfiguration AddAutomaticDetectionCQRS(this IConfiguration startup, Assembly assembly)
            => startup.AddServices(services
                => services.AutomaticDetectCQRSElements(assembly));

        public static IConfiguration AddCommandBus(this IConfiguration startup)
            => startup.AddServices(services
                    => services.AddDefaultCQRSItems());

        public static IConfiguration AddDataContext(this IConfiguration startup)
